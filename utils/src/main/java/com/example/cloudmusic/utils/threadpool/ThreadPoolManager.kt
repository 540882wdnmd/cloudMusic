package com.example.cloudmusic.utils.threadpool
...
class ThreadPoolManager private constructor() {
     ...
     * 线程池中最大线程数量
     */
    private val MAXIMUM_POOL_SIZE = 30
        ...
        if (threadPoolExecutor == null) {
            threadPoolExecutor = ThreadPoolExecutor(
                ...
                RejectedExecutionHandler { _, _ ->
                    Log.d(tag,"$ThreadPoolManager  RejectedExecutionHandler----")
                }
            )
            //允许核心线程闲置超时时被回收
